...
namespace FluentValidation.Blazor
{
    public static class Guard
    {
        ...
        public static IEnumerable<T> NotNullOrEmpty<T>(IEnumerable<T> collection, string exception) where T : class
        {
            ...
            if (collection == null || !notNullOrEmpty.Any()) throw new InvalidOperationException(exception);
        ...
        public static List<T> NotNullOrEmpty<T>(List<T> collection, string exception) where T : class
        {
            ...
            if (collection == null || collection.Count == 0) throw new InvalidOperationException(exception);
